...
"""  
---------- Edit 11/19/2016 ----------
-Made the north/south traveling cars identical in characteristics to the east/west traveling cars.
-Added path for vehicles to travel north.
-gave all travel paths equal weight
...
def generate_routefile():
    ...
    with open("data/cross.rou.xml", "w") as routes:
     ...
     |--|--------->|--|--------->|--|            
		...
		Edges with a prefix of '5' lead to/from terminal nodes.
		Edges are origin destination pairs.
		Edges with a suffix of 'i' lead into the specified node.
		Edges with a suffix of 'o' are leaving the specified node.
